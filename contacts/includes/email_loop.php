...
if(!$emailRowCount){
 ...
 echo "<a ".$dataset." href='#' title='Show/Hide Emails'style='position: relative; left: 50px;' onclick='myFunction(tbl_email". $contactId .")'><span><i class='fas fa-chevron-down'></i>&nbsp Emails (". $emailRowCount .")&nbsp</span></a>";
 echo "<thead>";
 echo "<tr>";
 echo "<th></th>";
 echo "<th>Email</th>";
