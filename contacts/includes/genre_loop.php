...
while ($row = mysqli_fetch_assoc($genre_types_result)) {
  ...
  echo "<a href='#' title='Show/Hide Genres'style='position: relative; left: 50px;' onclick='myFunction(tbl_genre". $contactId .")'><span><i class='fas fa-chevron-down'></i>&nbsp Genre Type (". $genreRowCount .")&nbsp</span></a>";
  echo "<thead>";
  echo "<tr>";
