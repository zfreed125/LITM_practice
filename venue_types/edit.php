...
$sql = "select id, venueType from venue_types where id='$id';";
                            ...
                            <div class="flip-card-inner">
                                ...
                                <div class="flip-card-back">
                                    <div class="input-group mt-3 mb-1 input-group-sm p-1 w-75">
                                        ...
                                        <input type="text" name="venueType" class="form-control" value="<?php echo $venueType; ?>">
                                    </div>
                                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                                </div>
                            </div>          
                        </div> <!-- Flip End -->
                        <p>Hover over Image to edit Venue Fields</p>
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
