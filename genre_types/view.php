            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Genre Type List</h2>
                        <a href="add.php" class="btn btn-success pull-right">Add New Genre Type</a>
                    </div>
                    <?php
                    // Include config file
