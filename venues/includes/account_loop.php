...
while ($row = mysqli_fetch_assoc($account_types_result)) {
 ...
 echo "<a href='#' title='Show/Hide accounts'style='position: relative; left: 50px;' onclick='myFunction(tbl_account". $venuesId .")'><span><i class='fas fa-chevron-down'></i>&nbsp Account Type (". $accountRowCount .")&nbsp</span></a>";
 echo "<thead>";
 echo "<tr>";
