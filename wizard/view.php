            ...
            <div class="wrapper pull-left">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        $sql = "SELECT contacts.*, addresses.*, addresses.id as address_id, contacts.id as contact_id FROM addresses INNER JOIN contacts ON contacts.Id = addresses.contactId;";
